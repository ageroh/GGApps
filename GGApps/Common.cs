...
namespace GGApps
{
    public class Common : System.Web.UI.Page
    {
        ...
        public async Task<CancellationToken> RunAsyncCommandBatch(CancellationToken ct, int appID, string appName, string command, string actualWorkDir, string ExplainCmd, string mapPath, CreateLogFiles log, bool redirectOut = true)
        {
        ...
        public int RunSyncCommandBatch( int appID, string appName, string command, string actualWorkDir, string ExplainCmd, string mapPath, CreateLogFiles log, bool redirectOut = true)
        {
            // perform a long running operation, e.g. network service call, computation, file IO
            ProcessStartInfo procStartInfo;
            ...
            {
                log.ErrorLogAdmin(mapPath, "Error while creating Process : " + ex.Message, appName);
                return -1;
            }
        ...
        public static void NetErrorDataHandler(object sendingProcess, DataReceivedEventArgs errLine)
        {
