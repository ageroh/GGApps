...
sqlcmd -S localhost -d ContentDB_165_Lan_2_Cat_%2 -U ContentAbility_User_165 -P 3E6EA993-5EBA-4648-BF18-83C38D3E26DC -Q "set nocount on SELECT text FROM entity_text_vw quit" -W -h -1 -o entity_text.txt
