...
echo *** images in db	>> %3
echo *					>> %3
sqlcmd -S 10.0.64.32 -d ContentDB_165_Lan_1_Cat_%2 -U ContentAbility_User_165 -P 3E6EA993-5EBA-4648-BF18-83C38D3E26DC -i db_number_of_images.sql -h -1 	>> %3
echo *	>> %3
...
echo *	>> %3
echo *** images in remote dir (%path_to%)	>> %3
echo *	>> %3
dir /b %path_to% | wc -l | sed "s/^ */* /"	>> %3
echo *	>> %3
